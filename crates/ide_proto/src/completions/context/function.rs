use auto_lsp::{core::span::Span, default::db::BaseDatabase, lsp_types::{CompletionContext, CompletionItem}};
use hir::{
    HirNodeInfo,
    hir_def::pous::{function::Function, function_block::FunctionBlock},
};

use crate::completions::{context::{PouCompletionCtx, PrecizeCompletion, ScopeCompletionCtx}, static_snippets::{all_stmts, fn_var_snippets}};
