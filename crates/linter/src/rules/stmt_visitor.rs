...
pub fn check<'db>(
    ...
    let ctx = VisitorCtx {
        ...
        unnecessary_else: crate::rules::is_enabled(config, unnecessary_else::NAME),
        uninitialized_output: crate::rules::is_enabled(config, uninitialized_output::NAME),
        negated_condition: crate::rules::is_enabled(config, negated_condition::NAME),
        ...
        redundant_not: crate::rules::is_enabled(config, redundant_not::NAME),
        sub_self: crate::rules::is_enabled(config, sub_self::NAME),
        negated_comparison: crate::rules::is_enabled(config, negated_comparison::NAME),
        duplicate_case: crate::rules::is_enabled(config, duplicate_case::NAME),
        empty_case_branch: crate::rules::is_enabled(config, empty_case_branch::NAME),
        default_for_step: crate::rules::is_enabled(config, default_for_step::NAME),
