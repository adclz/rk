...
END_FUNCTION_BLOCK"#;
    ...
    [E0309] Error: invalid literal
     ...
     4 |         c : CHAR := CHAR#'ab';
       |                     ^^^^|^^^^  
       |                         `------ cannot infer 'CHAR literal' to 'CHAR': CHAR literal must be exactly 1 character, got 2
    ---'
    ");
}
...
END_FUNCTION_BLOCK"#;
    ...
    [E0309] Error: invalid literal
     ...
     4 |         c : WCHAR := WCHAR#"ab";
       |                      ^^^^^|^^^^  
       |                           `------ cannot infer 'WCHAR literal' to 'WCHAR': WCHAR literal must be exactly 1 character, got 2
    ---'
    "#);
}
