...
// L0204 is a *lint* that fires only on FUNCTION_BLOCK / PROGRAM call sites
// where one or more VAR_INPUT arguments are omitted. The corresponding case
// on FUNCTION/METHOD callees is the hard error E0233 (covered by
...
// FUNCTION/METHOD callees are E0233 territory - L0204 must stay silent on
